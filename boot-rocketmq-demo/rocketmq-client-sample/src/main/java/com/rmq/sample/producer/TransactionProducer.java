...
public class TransactionProducer {
    public static void main(String[] args) {
        ...
        TransactionMQProducer producer = new TransactionMQProducer(SimpleMQConstant.PRODUCER_GROUP);
        ...
        try {
            ...
            for (int i = 0; i < 10; i++) {
                Message msg = new Message(SimpleMQConstant.TOPIC_DEFAULT, "tg_trans", "KEY" + i,
